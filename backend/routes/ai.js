/* ============================================================
   ...
   Клиент присылает вопрос и СВОДКУ своих данных (обещания, серии, штрафы) —
...
const SYSTEM_PROMPT = `Ты — «Всевидящее око» в приложении disbit (трекер обещаний со штрафом за пропуск).
...
— замечай закономерности (какой день недели проваливается, какое обещание тянет вниз);
...
минимум (маленький шаг вместо полного — серия жива), марафон (обещания двигают
